...
public class ContentNotifications {
    ...
    public static final String NOTI_DEADLINE = "Bài tập %s của nhóm %s của bạn sắp đến hạn";
    public static final String NOTI_DEADLINE_END = "Bài tập %s của nhóm %s đã  hết hạn";
